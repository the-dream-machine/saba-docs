...
This step is optional.<br/><br/> Whenever you perform an action such as changing the volume or changing the channel, IINA will display a box in the upper-left corner showing the property that has been modified.
